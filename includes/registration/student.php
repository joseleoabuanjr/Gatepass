    ...
    <div class="glass-effect d-flex align-items-center vh-100">
        <div class="container bg-white shadow-lg py-3 px-5" style="width: 750px;">
            ...
            <form method="post" action="../../function/toRegister.php?id=1" enctype="multipart/form-data">
                    ...
                    <div class="row row-cols-1 row-cols-md-3 g-2">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="studentNo" id="studentNo" required>
                            </div>
                        </div>
                        <div class="col">
                            <div class="mb-3">
                                <label class="form-label">* College</label>
                                <select class="form-select mb-3" name="strand" required>
                ...
                <!-- <div class="d-grid gap-2 d-md-flex justify-content-md-between">
                    <div class="form-text fw-bolder">Already have an account? <a href="../login/login.php" class="text-info text-decoration-none" style="cursor: pointer;">Log in</a></div>
